    ...
    <div className="p-4 bg-white shadow-md flex items-center justify-center">
      ...
      <div className="ml-auto mr-5 flex items-center gap-5">
        <span className="relative w-7">
          ...
          <span className="w-5 h-5 rounded-full flex items-center justify-center text-white text-xs bg-pink-600 absolute top-1 right-0 translate-x-2/4">
            {cartItemsCount || 0}
          </span>
        </span>
        <span className="relative w-8">
          ...
          <span className="w-5 h-5 rounded-full flex items-center justify-center text-white text-xs bg-pink-600 absolute top-0 right-0 translate-x-2/4">
            {favouritesCount || 0}
          </span>
        </span>
      </div>
